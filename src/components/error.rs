        ...
        <section class="bg-white">
            <div class="py-8 px-4 mx-auto h-screen max-w-screen-xl flex justify-content-center items-center lg:py-16 lg:px-6">
                <div class="mx-auto max-w-screen-sm text-center">
                    ...
                    <a href="#" class="inline-flex text-white bg-[#AC1E23] hover:bg-[#AC1E23]/75 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4">{ "Back to Homepage" }</a>
                </div>   
            </div>
        </section>
    }
